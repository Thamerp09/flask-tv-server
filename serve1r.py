...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://flask-tv-server.onrender.com"}}, supports_credentials=True)
...
def after_request(response):
    ...
    response.headers.add('Access-Control-Allow-Origin', '*')  # أو حدد الدومين
    return response
...
@app.route('/volume_up', methods=['POST','OPTIONS'])
def volume_up():
